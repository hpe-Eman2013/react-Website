...
export default function MissionVision() {
  return (
    <div className="container py-4">
      <div className="mb-4">
        <h1 className="h3 mb-1">Mission & Vision Statement</h1>
      ...
      <div className="card shadow-sm">
        <div className="card-body">
          {/* OUR MISSION & VISION (MERGED) */}
          <h2 className="h5 mb-3">Our Mission &amp; Vision</h2>

          <h3 className="h6 text-uppercase text-muted mb-2">The Vision</h3>
          <p className="mb-4">
            To see a remnant restored to the ancient paths of Yahuah Elohim,
            walking in the fullness of truth as revealed through the Messiah
            Yahusha. We envision a community of believers who are not only
            spiritually set apart but are also physically and legally equipped
            to live as true stewards of the earth, independent of worldly
            systems and grounded in the Covenant.
          </p>

          <h3 className="h6 text-uppercase text-muted mb-2">The Mission</h3>
          <p className="mb-3">
            Our mission is to provide a comprehensive education for the whole
            man—spirit, mind, and body. We are dedicated to:
          </p>

          <ul className="mb-4">
            <li>
              <strong>Restoring the Name:</strong> Proclaiming the set-apart
              names of our Creator, Yahuah, and His Son, Yahusha, as we strip
              away the traditions of men to return to the pure language of the
              Scriptures.
            </li>
            <li>
              <strong>The Way of Truth:</strong> Teaching the faith of The Way
              (Acts 24:14), acknowledging the Torah as our living instructions
              for righteous conduct.
            </li>
            <li>
              <strong>Kingdom Governance:</strong> Educating believers in the
              Law of Equity and Trust Law, empowering them to navigate worldly
              jurisdictions with wisdom and to manage their affairs according to
              the higher principles of the Kingdom.
            </li>
            <li>
              <strong>Sustainable Stewardship:</strong> Teaching the foundations
              of Agriculture to ensure the remnant can cultivate the land,
              provide for their families, and honor Yahuah’s creation through
              biblical land sabbaths and natural growth.
            </li>
          </ul>

          {/* Keep your original concise mission/vision language (blended below) */}
          <div className="alert alert-light border mb-4" role="note">
            ...
            <ul className="mb-2">
              ...
              <li>
                Community outreach that reflects the love, justice, and mercy of
                Yahuah.
              </li>
            </ul>
            <p className="mb-0">
          ...
          {/* CORE PILLARS */}
          <h2 className="h5 mb-3">Our Core Pillars</h2>
            ...
            <table className="table table-sm align-middle mission-table">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    Returning to the Paleo Hebrew foundations and the testimony
                    of Yahusha.
                  </td>
                </tr>
                <tr>
          ...
          <blockquote className="blockquote mission-quote mb-4">
            <p className="mb-2">
              ...
              heresy, so worship I the Elohim of my fathers, believing all
          ...
          {/* WHY THESE THREE */}
          <h2 className="h5 mb-3">Why These Three?</h2>
          <p className="mb-3">
          ...
          <ul className="mb-4">
            ...
            <li>
              <strong>Trust Law</strong> provides the legal framework to protect
              the ministry&apos;s assets and the family&apos;s inheritance from
          ...
          {/* COLLAPSIBLE FOUNDATIONS SECTION */}
            ...
            <div className="mt-3">
              ...
              <ol className="mb-4">
                <li className="mb-3">
                  ...
                  <ul className="mt-2">
                    <li>
                      <strong>The Settlor:</strong> Yahuah Elohim, who owns the
                      earth and everything in it (Tehillim / Psalms 24:1).
                    </li>
                    <li>
                    ...
                    <li>
                      <strong>The Mandate:</strong> In Mattithyahu / Matthew 25,
                      the master leaves his goods with his servants. The one who
                      sat on the asset was rebuked, while those who put the
                      assets to work for the benefit of the Master&apos;s estate
                      were rewarded.
                    </li>
                    <li>
                      <strong>The Lesson:</strong> Operating in a Trust is a
                      divine duty. We manage Yahuah&apos;s assets for His glory,
                      not our own.
                    </li>
                  </ul>
                </li>
                ...
                <li className="mb-3">
                  ...
                  <ul className="mt-2">
                    ...
                    <li>
                      ...
                      The “Letter of the Law” (as interpreted by the Pharisees)
                      suggested no work should be done.
                    </li>
                    <li>
                      Yahusha applied Equity: “Is it lawful to do good or to do
                      evil on the Sabbath?” (Markos / Mark 3:4).
                    </li>
                    <li>
                ...
                <li className="mb-3">
                  ...
                  <ul className="mt-2">
                    ...
                    <li>
                      <strong>The Lesson:</strong> Integrity is the “fuel” of an
                      equitable claim. We cannot seek remedy while acting in
                      fraud or malice.
                    </li>
                  </ul>
                </li>
                ...
                <li className="mb-0">
                  ...
                  <ul className="mt-2">
                    ...
                    <li>
                      ...
                      “merchant” system and place it back into the jurisdiction
                      of The Way.
                    </li>
                    <li>
                      <strong>Equity in Harvest:</strong> Leaving the corners of
                      the field for the poor (Wayyiqra / Leviticus 19:9) is an
                      equitable distribution that cares for the community
          ...
          {/* SUMMARY TABLE */}
          <h2 className="h5 mb-3">Kingdom vs. Worldly Jurisdiction</h2>
          ...
          {/* Keep your original short “vision summary” closeout */}
          <p className="mb-0">
